...
// ===============================
// LOVE SONG CONTROL (ADD BELOW)
// ===============================

let songPlayed = false;

function startLove() {
  if (songPlayed) return;   // already played na stop
  songPlayed = true;
  ...
  music.loop = false;      // VERY IMPORTANT
  music.volume = 0.8;
  ...
  // song mudinja udane STOP
  music.onended = () => {
    music.pause();
    music.currentTime = 0;
    console.log("Song ended properly");
  };
}
document.querySelectorAll('.photo-card').forEach(card => {
